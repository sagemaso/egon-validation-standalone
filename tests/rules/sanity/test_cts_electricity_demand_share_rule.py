"""
Test for CtsElectricityDemandShareRule
"""
...
class TestCtsElectricityDemandShareRule(unittest.TestCase):
    
    def setUp(self):
        """Set up test fixtures"""
        self.mock_db_manager = Mock(spec=DatabaseManager)
        self.rule = CtsElectricityDemandShareRule(self.mock_db_manager)
        
    def test_get_cts_electricity_demand_share_data_success(self):
        """Test successful retrieval of CTS electricity demand share data"""
        mock_data = [
        ...
        result = self.rule._get_cts_electricity_demand_share_data()
    ...
    def test_get_cts_electricity_demand_share_data_database_error(self):
    ...
    def test_validate_no_data(self):
        ...
        self.assertEqual(result.status, "CRITICAL_FAILURE")
        self.assertIn("No CTS electricity demand share data found", result.error_details)
